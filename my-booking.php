                  ...
                  <div class="profile_wrap">
                    ...
                    <div class="my_vehicles_list">
                      <ul class="vehicle_listing">
                        <?php
                        $useremail = $_SESSION['login'];
                        $sql = "SELECT tblvehicles.Vimage1 as Vimage1, tblvehicles.VehiclesTitle, tblvehicles.id as vid, tblbrands.BrandName, tblbooking.FromDate, tblbooking.ToDate, tblbooking.totalprice, tblbooking.Status, DATEDIFF(tblbooking.ToDate, tblbooking.FromDate) as Duration from tblbooking join tblvehicles on tblbooking.VehicleId=tblvehicles.id join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblbooking.userEmail=:useremail";
                        $query = $dbh->prepare($sql);
                        $query->bindParam(':useremail', $useremail, PDO::PARAM_STR);
                        $query->execute();
                        $results = $query->fetchAll(PDO::FETCH_OBJ);
                          ...
                          foreach ($results as $result) { ?>
                            <li>
                              ...
                              <div class="vehicle_title">
                                ...
                                <b>Durasi:</b> <?php echo htmlentities($result->Duration); ?> hari<br />
                                <b>To Date:</b> <?php echo htmlentities($result->ToDate); ?><br />
                                <b>Total harga:</b> Rp. <?php echo number_format(htmlentities($result->totalprice), 0, ',', '.'); ?></p>
                              </div>
                              <div class="vehicle_status" style="text-align: center;">
